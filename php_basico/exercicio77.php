...
private Livro $livro;
    ...
    public function __construct(int $codigo, bool $cativa, bool $emprestada, Livro $livro)
    {
        $this->codigo = $codigo;
        $this->cativa = $cativa;
...
class Emprestimo
{
    ...
    public function __construct(string $dataDeEmprestimo, string $dataPrevistaDeDevolucao, string $dataDeEntregaReal, int $situacao, Usuario $usuario, Exemplar $exemplar){
