    ...
    <form action="{{route('documentos.inserir')}}" method="POST">
        ...
        <div class="row aling-items-center">
            <div class="col mb-3">
                ...
                <input type="number" class="form-control" name="tamanho_mb">
            </div>

            <div class="col mb-3">
                <label class="form-label" for="numero_assinaturas">Numero de Assinaturas</label>
                <input type="number" class="form-control" name="numero_assinaturas">
            </div>
        </div>
        ...
        <div class="row aling-items-center">
            <div class="col mb-3">
                ...
                <input type="text" class="form-control" name="assinatura_responsavel">
            </div>
