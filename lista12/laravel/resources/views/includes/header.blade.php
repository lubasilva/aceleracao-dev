...
<body>
    <div class="container">
        ...
        <ul class="nav nav-pills">
            <li class="nav-item"><a href="" class="nav-link">Desafio 1</a></li>
            <li class="nav-item"><a href="" class="nav-link">Desafio 2</a></li>
            <li class="nav-item"><a href="#" class="nav-link">Desafio 3</a></li>
            <li class="nav-item"><a href="" class="nav-link">Desafio 4</a></li>
        </ul>
        </header>
    </div>
